...
is_running(o::BlinkOutput) = is_running(o.interface) && o.window.content.sock.state == WebSockets.ReadyState(3) 
set_running(o::BlinkOutput, x) = o.window.content.sock.state == WebSockets.ReadyState(1) && set_running(o.interface, x) 
